...
-- 시나리오 정리
-- 1. 전체 캐릭터 중 직업별, 성별로 차지하는 비율을 구해보고자 합니다.
...
-- 4. PVP 매칭을 하려고 합니다. 특정 유저의 전투력을 바탕으로 +1000, -1000까지의 매칭을 시도합니다.
...
-- 5. PVE 빠른 파티 매칭을 하려고 합니다. 파티 인원수는 총 4명으로 구성되며, 같은 직업은 파티에 들어갈 수 없습니다.
